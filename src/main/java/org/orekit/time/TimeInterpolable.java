...
public interface TimeInterpolable<T extends TimeInterpolable<T>> {
     ...
     * </p>
     * <p>
     * Some implementations (typically the one for the specialized class
     * {@link
     * org.orekit.propagation.analytical.EcksteinHechlerPropagatorEcksteinHechlerPropagator.EHOrbit
     * EHOrbit} generated by the {@link
     * org.orekit.propagation.analytical.EcksteinHechlerPropagatorEcksteinHechlerPropagator
     * Eckstein-Hechler propagator}) enforce some constraints on the sample
     * about the orbit type contained in the sample and may throw an exception
     * if those constraints are not fulfilled by the sample.
     * </p>
